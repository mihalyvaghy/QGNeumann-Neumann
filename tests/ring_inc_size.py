...
parser = argparse.ArgumentParser(
        ...
        description='Run Neumann-Neumann algorithm and QG FEM on ring of cliques graphs of clique sizes',
        epilog='Bottom text.')
...
parser.add_argument('--K_min', action='store', default=10,
                    help='minimum clique size', type=int)
parser.add_argument('--K_step', action='store', default=1,
...
theta = 0.95
filename = 'ring_inc_size'

def create_graph(size):
    G = nx.ring_of_cliques(args.N, size)
