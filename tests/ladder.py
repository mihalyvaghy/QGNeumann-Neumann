...
parser = argparse.ArgumentParser(
        prog='QG solver for ladders',
        description='Run Neumann-Neumann algorithm and QG FEM on ladder graphs of various sizes',
        epilog='Bottom text.')
...
parser.add_argument('--N_max', action='store', default=250,
                    help='maximum graph size', type=int)
parser.add_argument('--N_min', action='store', default=100,
                    help='minimum graph size', type=int)
parser.add_argument('--N_step', action='store', default=30,
