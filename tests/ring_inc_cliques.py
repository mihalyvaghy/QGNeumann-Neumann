...
parser = argparse.ArgumentParser(
        ...
        description='Run Neumann-Neumann algorithm and QG FEM on ring of cliques graphs of various number of cliques',
        epilog='Bottom text.')
...
theta = 0.95
filename = 'ring_inc_cliques'

def create_graph(size):
    G = nx.ring_of_cliques(size, args.K)
